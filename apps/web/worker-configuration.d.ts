/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: aa83a6bd8cd349e6d71c8a6db317501f)
...
interface __BaseEnv_CloudflareEnv {
	...
	BROWSER: BrowserRun;
	ASSETS: Fetcher;
	AUTH_EMAIL_FROM: "Growlogue <growlogue@notify.aether42.com>";
	VAPID_PUBLIC_KEY: "BDUKd3gkeryq9LqFB_bEkPlP0eBhCs_k-K4n0KZadk3Y6LgVe7jMo_lOGzVL8mv7HHNbsax7zNrs8uMZvkAmpZE";
	OWNER_EMAIL: string;
	BETTER_AUTH_SECRET: string;
	BETTER_AUTH_URL: string;
	RESEND_API_KEY: string;
	REPORTS: Fetcher /* growlogue-reports */;
	AI_COACH: Fetcher /* growlogue-ai */;
	LIFE_UNLOCKS: Fetcher /* growlogue-life-unlocks */;
	GAME: Fetcher /* growlogue-game */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_EMAIL_FROM" | "VAPID_PUBLIC_KEY" | "OWNER_EMAIL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "RESEND_API_KEY">> {}
}
